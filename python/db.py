...
def init_db():
    ...
    migrations = [
        ...
        """CREATE TABLE IF NOT EXISTS facilities (id TEXT PRIMARY KEY, name TEXT NOT NULL DEFAULT '', type TEXT DEFAULT 'other', status TEXT DEFAULT 'active', address TEXT DEFAULT '', city TEXT DEFAULT '', state_zip TEXT DEFAULT '', lat REAL, lon REAL, phone TEXT DEFAULT '', phone2 TEXT DEFAULT '', freq TEXT DEFAULT '', freq2 TEXT DEFAULT '', tone TEXT DEFAULT '', capacity TEXT DEFAULT '', contact TEXT DEFAULT '', callsign TEXT DEFAULT '', generator TEXT DEFAULT '', ada TEXT DEFAULT '', notes TEXT DEFAULT '', updated TEXT DEFAULT '')""",
    ]
