...
cat << 'BANNER'
  ...
  ╚════██║╚════██║██║╚██╗██║██╔══╝     ██║
    ...
    Dedicated Gateway Pi — FieldCommand EMCOMM-NET
...
# Gateway Pi — FieldCommand EMCOMM-NET
...
<title>AMPRNet Gateway Status — FieldCommand</title>
<style>
  :root {
...
<div class="header">
  <div class="header-left">
    ...
    <p>FieldCommand EMCOMM-NET  ·  K9ESV  ·  44.0.0.0/8</p>
  </div>
...
<div class="footer">
  FieldCommand IMS v1.0  ·  AMPRNet Gateway  ·  K9ESV  ·  MCESV/MCEMA
</div>
...
echo -e "   Click Apply."
echo ""
echo -e "${BOLD}4. Verify from the FieldCommand Pi:${NC}"
