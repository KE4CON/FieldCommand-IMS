...
story.append(tbl(['PAGE', 'URL', 'NOTES'], [
    ...
    ['Tactical APRS Map',            '/tactical.html', 'Leaflet — RF APRS always, APRS-IS when WAN up, CalTopo / SARTopo overlay'],
    ['CalTopo / SARTopo GeoJSON Import',       '/caltopo_import.html', 'Import planning overlays from CalTopo / SARTopo — persists on tactical map'],
...
story.append(H2('Incident Archive and Exercise / Scenario Reset'))
