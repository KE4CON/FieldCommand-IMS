# FieldCommand Documentation Generators

## CRITICAL — READ THIS FIRST

These scripts build all FieldCommand documentation PDFs.
...
1. Copy the updated script to fieldcommand/docs_generators/
2. Copy the updated PDF to fieldcommand/docs/
...
|-----|-----------|--------|
| FieldCommand_Installation_Guide.pdf | gen_install_guide.py | LOST - needs rebuild |
| FieldCommand_Complete_User_Manual_v1.0.pdf | manual_build.py + manual_ch_*.py | LOST - needs rebuild |
| McHenry_County_RACES_*.pdf | gen_user_guide.py | LOST - needs rebuild |
| FieldCommand_Field_Quick_Reference.pdf | gen_field_quickref.py | LOST - needs rebuild |
